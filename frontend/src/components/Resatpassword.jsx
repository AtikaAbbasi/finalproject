...
const Resatepassword = () => {
  ...
  const handleResetPswd = async (e) => {
    e.preventDefault();
    try {
      const { data } = await axios.post(`${import.meta.env.VITE_BACKEND_URL}/auth/reset`, { token,password })
      setPassword("");
      setConfirmPassword("");
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute inset-y-0 right-0 px-3 py-2 text-sm text-gray-600 hover:text-purple-600"
              >
                Show
              </button>
            </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute inset-y-0 right-0 px-3 py-2 text-sm text-gray-600 hover:text-purpel-600"
              >
                Show
              </button>
            </div>
